...
const COMPONENT_HEADER = [
    ...
    {
        key: "tumpatan_komposisi_1",
        title: "Tumpatan Komposisi 1",
        sortable: false,
    },
    {
        key: "tumpatan_komposisi_2",
        title: "Tumpatan Komposisi 2",
        sortable: false,
    },
    {
        key: "tumpatan_komposisi_3",
        title: "Tumpatan Komposisi 3",
        sortable: false,
    },
    {
        key: "tumpatan_komposisi_4",
        title: "Tumpatan Komposisi 4",
        sortable: false,
    },
    {
        key: "tumpatan_komposisi_5",
        title: "Tumpatan Komposisi 5",
        sortable: false,
    },
    {
        key: "totalakhir",
...
const COMPONENT_APIS = {
    getAllItems: "/v1/transaction/recapitulation/konservasi/viewall",
    // getHeader: "/v1/transaction/assesment/viewtrsassesmentheaderbyid",
    // getDetailPenilaian:
    //     "/v1/transaction/assesment/viewtrsassesmentdetalbyidandtype",
...
<template v-slot:form="{ forms }">
    <v-container>
        <h4>Form Rekapitulasi Penilaian</h4>
        <br />
        ...
        <RekapitulasiComponent
            ...
            :apis="COMPONENT_APIS"
            :idemr="COMPONENT_IDEMR">
            <template v-slot:form="{ forms }">
                <v-form>
                    <v-row>
                        <v-col cols="12" md="12">
                            <v-textarea
                                v-model="forms.assesmentdescription"
                                variant="outlined"
                                readonly
                                label="Deskripsi Penilaian"></v-textarea>
                        </v-col>
                    </v-row>
                    <!-- <v-row>
                                <v-col cols="12" md="12">

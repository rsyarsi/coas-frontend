...
const COMPONENT_BADGE = [ "Master", "Data", "Grup Spesialis (ASM)", ];
...
{
    getAllItems: "/v1/masterdata/specialistgroups/viewall",
    getItem: "/v1/masterdata/specialistgroups/view/id",
    createItem: "/v1/masterdata/specialistgroups/create",
    updateItem: "/v1/masterdata/specialistgroups/update",
};

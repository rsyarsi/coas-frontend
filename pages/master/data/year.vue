...
const COMPONENT_BADGE = [ "Master", "Data", "Tahun", ];
...
{
    getAllItems: "/v1/masterdata/years/viewall",
    getItem: "/v1/masterdata/years/view/id",
    createItem: "/v1/masterdata/years/create",
    updateItem: "/v1/masterdata/years/update",
};
...
<template>
    <ItemComponent :badge="COMPONENT_BADGE" :header="COMPONENT_HEADER" :forms="COMPONENT_FORMS" :apis="COMPONENT_APIS">
        <template v-slot:form="{ forms, }">
            <v-form>
                <v-text-field v-model="forms.name" label="Tahun"></v-text-field>
                ...
                <v-container>
                    <v-row>
                        <v-col>
                            ...
                            <v-row><v-text-field label="Tahun" variant="underlined" :model-value="item.name"></v-text-field></v-row>
                        </v-col>
                        <v-spacer></v-spacer>
                        <v-col>
                            <v-row>

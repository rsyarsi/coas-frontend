...
<template v-slot:form="{ forms }">
    <v-form>
        <v-container>
            <v-card>
                <h1 align="center">
                    LEMBAR INTERPRETASI PANORAMIK RKG 1<br />
                </h1>
                ...
                <v-container fluid>
                    <v-container fluid>
                        ...
                        <v-row>
                            <v-col rows="2" cols="12">
                                <v-textarea
                                    v-model="forms.panoramik_miising_teeth"
                                    label="Missing Teeth"
                                    variant="outlined"></v-textarea>
                            </v-col>
                        </v-row>
                        ...
                        <v-row>
                            <v-col rows="2" cols="12">
                                <v-textarea
                                    v-model="forms.panoramik_persistensi"
                                    label="Persistensi"
                                    variant="outlined"></v-textarea>
                            </v-col>
                        </v-row>
                        ...
                        <v-row>
                            <v-col rows="2" cols="12">
                                <v-textarea
                                    v-model="forms.panoramik_impaki"
                                    label="Impaksi"
                                    variant="outlined"></v-textarea>
                            </v-col>
                        </v-row>
                        ...
                        <v-row>
                            <v-col rows="2" cols="12">
                                <v-textarea
                                    v-model="forms.panoramik_kondisi_mahkota"
                                    label="Kondisi Mahkota"
                                    variant="outlined"></v-textarea>
                            </v-col>
                        </v-row>
                        ...
                        <v-row>
                            <v-col rows="2" cols="12">
                                <v-textarea
                                    v-model="forms.panoramik_kondisi_akar"
                                    label="Kondisi Akar"
                                    variant="outlined"></v-textarea>
                            </v-col>
                        </v-row>

...
{
    const getItem = async (url: string, item: string = "", fnSuccess: Function, fnError: Function): Promise<void> =>
    {
        if (! item) {
    ...
    const setItem = async (url: string, item: string = "", items: any = {}, fnSuccess: Function, fnError: Function): Promise<void> =>
    {
        if (! item) {
